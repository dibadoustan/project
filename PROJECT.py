...
def main_menu():
 ...
 if __name__ == "__main__":
    ...
    photographer = photographers(1000, "photographer_code", "photographer_name", "photographer_email")
    article = articles(1000, "keyworks", "title", "category")
    writer = writers(1000, "writer_code", "writer_name", "writer_email")
    ai_website.add_data(image)
    ai_website.add_data(photographer)
    ai_website.add_data(article)
    ai_website.add_data(writer)
